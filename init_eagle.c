...
hid_t init_eagle(char *file_path_fmt, eagle_t *eagle)
{
  ...
  high5err = read_h5attrs(
    ...
    "HubbleParam", H5T_NATIVE_DOUBLE, &(eagle->header.HubbleParam), optional_attr,
    "Omega0", H5T_NATIVE_DOUBLE, &(eagle->header.Omega0), optional_attr,
    "OmegaBaryon", H5T_NATIVE_DOUBLE, &(eagle->header.OmegaBaryon), optional_attr,
    "OmegaLambda", H5T_NATIVE_DOUBLE, &(eagle->header.OmegaLambda), optional_attr,
    "Redshift", H5T_NATIVE_DOUBLE, &(eagle->header.Redshift), optional_attr,
    "Time", H5T_NATIVE_DOUBLE, &(eagle->header.Time), optional_attr,
    ...
    "NumPart_ThisFile", H5T_NATIVE_INT, &(eagle->header.NumPart_ThisFile), optional_attr,
    "NumPart_Total", H5T_NATIVE_UINT, &(eagle->header.NumPart_Total), optional_attr,
  ...
  high5err = read_h5attrs(
    file_id, "Units",
    "UnitDensity_in_cgs", H5T_NATIVE_DOUBLE, &(eagle->units.UnitDensity_in_cgs), optional_attr,
    "UnitEnergy_in_cgs", H5T_NATIVE_DOUBLE, &(eagle->units.UnitEnergy_in_cgs), optional_attr,
    "UnitLength_in_cm", H5T_NATIVE_DOUBLE, &(eagle->units.UnitLength_in_cm), optional_attr,
    "UnitMass_in_g", H5T_NATIVE_DOUBLE, &(eagle->units.UnitMass_in_g), optional_attr,
    "UnitPressure_in_cgs", H5T_NATIVE_DOUBLE, &(eagle->units.UnitPressure_in_cgs), optional_attr,
    "UnitTime_in_s", H5T_NATIVE_DOUBLE, &(eagle->units.UnitTime_in_s), optional_attr,
    "UnitVelocity_in_cm_per_s", H5T_NATIVE_DOUBLE, &(eagle->units.UnitVelocity_in_cm_per_s), optional_attr,
    NULL
  );
  ...
  high5err = read_h5attrs(
    ...
    "GRAVITY", H5T_NATIVE_DOUBLE, &(eagle->constants.GRAVITY), optional_attr,
    "HUBBLE", H5T_NATIVE_DOUBLE, &(eagle->constants.HUBBLE), optional_attr,
    "PI", H5T_NATIVE_DOUBLE, &(eagle->constants.PI), optional_attr,
    "PLANCK", H5T_NATIVE_DOUBLE, &(eagle->constants.PLANCK), optional_attr,
    "PROTONMASS", H5T_NATIVE_DOUBLE, &(eagle->constants.PROTONMASS), optional_attr,
    ...
    "SOLAR_MASS", H5T_NATIVE_DOUBLE, &(eagle->constants.SOLAR_MASS), optional_attr,
  ...
  high5err = read_h5attrs(
    ...
    "InitAbundance_Helium", H5T_NATIVE_FLOAT, &(eagle->runtime_pars.InitAbundance_Helium), optional_attr,
    "InitAbundance_Hydrogen", H5T_NATIVE_FLOAT, &(eagle->runtime_pars.InitAbundance_Hydrogen), optional_attr,
    ...
    "SF_THRESH_MaxPhysDens_HpCM3", H5T_NATIVE_FLOAT, &(eagle->runtime_pars.SF_THRESH_MaxPhysDens_HpCM3), optional_attr,
